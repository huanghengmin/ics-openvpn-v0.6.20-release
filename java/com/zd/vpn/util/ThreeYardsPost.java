...
public class ThreeYardsPost {
    ...
    public ThreeYardsPost(Context context, String ip, String port,String imei,String sim,String sn) {
                        ...
                        if (flag) {
                            ...
                            if (!"".equals(code) || code != null) {
                                ...
                                handler.post(new Runnable() {
                                    @Override
                                    public void run() {
                                        String code = ReturnCode.RETURN_CLIENT_MSG_ERROR;
